...
Public Class CetakPengembalian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UAS_201804004.CetakPengembalian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCetakPengembalian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CetakPengembalian = New CetakPengembalian()
        rpt.Site = Me.Site
        Return rpt
    End Function
